export default {
  ...
  introduction:
    'Pe data de 1 noiembrie 2020 au loc alegerile parlamentare din Republica Moldova. Cetățenii cu drept de vot care au domiciliul sau reședința în străinătate pot vota la secție. Pentru a afla care sunt pașii pe care trebuie să îi parcurgeți pentru a putea alege în cadrul acestui tur electoral, consultați ghidul de mai jos.',
  about: {
  ...
  social_share: {
    ...
    text:
      'Distribuie aceste informații în social media pentru a ajuta cât mai mulți cetațeni să afle unde pot vota la alegerile prezidențiale din 2020, de ce documente au nevoie și alte sfaturi utile.',
  },
  donate_card: {
    title: 'Susține-ne',
    text:
