export default {
  ...
  votersGuide: {
    ...
    textHeader:
      '<p>На парламентские выборах только граждане Молдовы, проживающие или зарегистрированы за границей, реализуют свое право голоса за границей. Узнайте, что вам нужно сделать, чтобы проголосовать в стране вашего проживания на выборах 11 июля 2021 года.</p><h3>Важно!</h3><p><strong>Для голосования за границей необходимы следующие документы:</strong></p><ul><li>Паспорт гражданина Республики Молдова, в том числе с истекшим сроком действия,</li> <li>Удостоверение личности (действительное) с сопроводительной картой</li> <li>Kнижка моряка.</li></ul>Голосование будет проходить с 07.00 до 21.00 (по местному времени каждого избирательного участка).</p><p>Убедитесь, что у вас есть ручка и маска для лица. Каждый избирательный участок будет дезинфицироваться каждые 2-3 часа. На каждом избирательном участке количество избирателей, которые будут иметь доступ одновременно, будет равно количеству установленных кабин для голосования!</p>',
  },
  pollingStationSearch: {
    question: 'Где ты живешь?',
    callToAction:
      'Найдите в городе, где вы живете, ближайшие избирательные участки.',
    searchPlaceholder:
    ...
    error: 'Ne pare rau, a aparut o eroare.',
  },
  pollingStationCard: {
    distance: 'Расстояние:',
    seeStreets: 'посмотреть на карте',
    pollingStationNumber: 'Secția de votare Nr.',
    address: 'Адрес:',
    nrInregistrari: 'Зарегистрированные избиратели',
  },
  exceptional_cases: {
    case1_title:
  ...
  introduction:
    '11 июля 2021 состоятся выборы президента Республики Молдова. Граждане Молдовы с правом голоса, проживающие за границей, могут голосовать на избирательном участке.Чтобы узнать, какие шаги необходимо предпринять, чтобы проголосовать в этом раунде выборов, ознакомьтесь с гидом ниже.',
  about: {
    title: 'О Проекте',
    text: `<p>Vot Diaspora - это платформа, которая помогает гражданам, находящимся за рубежом, в поиске информации по поводу избирательного процесса - парламентские выборов, которые состоятся 11 июля 2021 года. Vot Diaspora - это проект, разработанный организацией Code For Moldova, призванный облегчить доступ граждан Молдовы за рубежом к информации и обеспечить большую прозрачность избирательного процесса.</p><p>Зайдя на <a href="https://votdiaspora.md">votdiaspora.md</a>, все граждане смогут проверить адреса избирательных центров, наряду с документами и процедурами, необходимыми для голосования на избирательном участке, в случае нахождения за пределами страны. Веб-сайт будет предоставлять обновленную информацию по каждому избирательному циклу. Vot Diaspora является частью избирательной экосистемы, разработанной волонтерами Code For Moldova. Концепция приложения была заимствована y Code For Romania, в рамках Civic Labs, одной из программ, в рамках которых ассоциация разрабатывает технологические решения для решения проблем страны и ее граждан.</p><p>Code for Moldova - это некоммерческая организация, которая на общественных началах разрабатывает цифровые решения для решения социальных проблем. Code For Moldova теперь достигла сообщества, состоящего из более чем 90 добровольцев из ИТ-сектора, которые разработали веб-приложения для Молдовы, например, из экосистемы <a href="https://voluntar.md">voluntar.md</a> и <a href="https://info.c19.md">info.c19.md</a>.</p>`,
    p1: 'Разработаной командой:',
    p2: 'При партнёрстве:',
  },
  info_text:
  ...
  temp_text:
    ' Harta secțiilor de votare disponibilă la acest moment este harta secțiilor organizate pentru alegerile prezidențiale din 2021.',
  social_share: {
    title: 'Сообщите своим друзьям!',
    text:
      'Поделитесь этой информацией в социальных сетях, чтобы помочь как можно большему количеству молдаван узнать, где они могут проголосовать на парламентские выборах 2021 года, какие документы им нужны и другие полезные советы.',
  },
  social_share_message:
    '11 июля 2021 года слово скажет диаспора. Молдаване повсюду имеют право избирать своих представителей в Парламент.',
  donate_card: {
    title: 'Поддержите нас',
    text:
      'votdiaspora - это проект, разработанный на общественных началах командой волонтеров Code for Moldova. Каждый день десятки ваших друзей и коллег работают над созданием полезных цифровых инструментов, которые облегчают жизнь и приближают Молдову к технологическому прогрессу. Помогите нам продолжить.',
  },
  cookie: {
